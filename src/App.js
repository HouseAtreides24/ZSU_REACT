...
import Simsons from "./components/Simsons";

//image import
import srcLion from '../src/images/images.jpg'
import srcBear from '../src/images/images (3).jpg'
import fox from '../src/images/images (6).jpg'
...
function App() {
  ...
  return (
      <div>
          {/*{*/}
          {/*    myArray.map(value => <Animals name={value.name} pic={value.pic}*/}
          {/*    styleClass={value.styleClass}/>)*/}
          {/*}*/}
          {/*{*/}
          {/*    userList.map(value => <Users name={value.name}*/}
          {/*    id={value.id} username={value.username}/>)*/}
          {/*}*/}

          {
              simpsons.map(value => <Simsons name={value.name}
              surname={value.surname} age={value.age} info={value.info}
              photo={value.photo} styleClass='simsons'/>)
          }
